...
def main(spark, userID):
    ...
    split_percentage = 80
    df_val = interactions_tracks.filter(col("row_number") > col("count") * split_percentage / 100)
    df_val.write.parquet("hdfs:/user/hk3820_nyu_edu/interactions_val_temporal_user.parquet")
